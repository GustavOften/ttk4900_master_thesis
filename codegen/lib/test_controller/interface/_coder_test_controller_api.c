...
static real_T emlrt_marshallIn(const emlrtStack *sp, const mxArray *theta, const
  char_T *identifier);
...
void test_controller_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  test_controller_xil_terminate();
  test_controller_xil_shutdown();
...
/* End of code generation (_coder_test_controller_api.c) */
